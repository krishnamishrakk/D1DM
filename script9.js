...
// }
// callPromise("1").then(()=>{console.log(2)}).then(()=>{callPromise("33")}).then(()=>console.log("4"))
...
//      console.log(d[0].innerText="hello krish");

//      function kk(){
//          document.getElementById("pp").style.flexDirection="row";
         
// //      }
//   function cb(alphabet){
//       return new Promise((res,rej)=>{
//       setTimeout(()=>{
//         console.log(alphabet)
//         res()
...
//   }cb("A").then(()=>cb("B")).then(()=>cb('C')).then(()=>cb("D"))
...
}kk(9).then(()=>kk(18)).then(()=>kk(27)).then(()=>kk(36)).then(()=>kk(45)).then(()=>kk(54)).then(()=>kk(63)).then(()=>kk(72)).then(()=>kk(81)).then(()=>kk(90))