...
*/
         ...
         //   the spread operator is used to expand / spread items in an array
// spread item convert array into a single item
...
console.log(obj1); // {name: 'aj', age: 20, clg: 'gkv'}


let obj2={...obj1};
console.log(obj2); //  {name: 'aj', age: 20, clg: 'gkv'}
obj2.lastname="sharma";
console.log(obj2); // {name: 'aj', age: 20, clg: 'gkv', lastname: 'sharma'}


// or
let obj3={...obj1,middlename:"kumar"}
console.log(obj3); // {name: 'aj', age: 20, clg: 'gkv', middlename: 'kumar'}
let obj4={...obj1,...obj2,...obj3,ishappy:true}
console.log(obj4); // {name: 'aj', age: 20, clg: 'gkv', lastname: 'sharma', middlename: 'kumar', …}